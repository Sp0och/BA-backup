...
public:
    ...
    vector<BRIEF::bitset> brief_window_descriptor_and_images;
    ...
    vector<BRIEF::bitset> search_brief_descriptor_and_images;
    ...
    cv::Mat orb_window_descriptor_and_images;
    ...
    cv::Mat search_orb_descriptor_and_images;

    // for BoW query
    vector<cv::Mat> bow_descriptor_and_images;
    ...
    bool findConnection(Frame* old_kf);
    ...
    bool searchInAera(const BRIEF::bitset window_descriptor_and_image,
